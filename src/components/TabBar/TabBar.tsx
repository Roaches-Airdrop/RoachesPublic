    ...
    return ( 
        ...
        <div className="flex items-center justify-center">
            <div className="fixed bottom-0 w-full z-[1000]">
                <div className="flex flex-wrap items-center justify-between bg-white bg-opacity-10 backdrop-blur-md rounded-tr-[20px] rounded-tl-[20px] py-4 xsm:px-6 px-2 shadow-lg">
                    {[
                        ...
                        <div 
                            ...
                            className={`flex flex-col items-center cursor-pointer py-[6px] px-2 transition-all duration-100 ${
